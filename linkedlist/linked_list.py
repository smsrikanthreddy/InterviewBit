...
print('the position is:', ll.get_position(3).value)

#insert a new value
# Test insert
ll.insert_element(e4,3)
# Should print 4 now
print('inserted value is:', ll.get_position(3).value)

#delete
ll.delete_element(1)
# Should print 2 now
print('after delete:', ll.get_position(1).value)
# Should print 4 now
